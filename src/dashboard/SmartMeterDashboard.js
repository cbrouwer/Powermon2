...
class SmartMeterDashboard extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    axios.get('/api/smartmeter/elec/history-months')
    ...
    axios.get('/api/smartmeter/elec/currentMonth')
      .then(function (response) {
 ...
 getCurrentConsumption() {
    ...
    axios.get('/api/smartmeter/elec/current')
      .then(function (response) {
        context.setState({
